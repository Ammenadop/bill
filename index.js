...
const port = 8000;
// const MID = "FUTUREGD";
// const SEC_ID = "futuregd";
// const CHECKSUM_KEY = "xRnRrh1qpH1EJnOAXsUSydwgBdbHirqH";
// const RETURN_URL = 'https://ccjinterview.com/getlinkresponse';
const MID = "BCRUISEPL";
const SEC_ID = "bcruisepl";
const CHECKSUM_KEY = "W0U5fRqcJe2GLEEqpYsm41CSiKLN73DJ";
const RETURN_URL = "https://alfrescogrand.com/getlinkresponse";
...
app.post("/getlink", (request, res) => {
  ...
  const linkk =
    "https://pgi.billdesk.com/pgidsk/PGIMerchantPayment" + "?msg=" + msg;
  res.send(linkk);
});
